...
from .utils.detect_face import detect_face_modified, detect_face, extract_face
...
class MTCNN(nn.Module):
    ...
    def __init__(
        ...
        select_largest=True, selection_method=None, keep_all=False, device=None, pretrained_model_path=None
    ):
        super().__init__()
        ...
        if pretrained_model_path:
            self.pnet = PNet(False)
            self.rnet = RNet(False)
            self.onet = ONet(False)
